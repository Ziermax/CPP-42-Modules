...
/*   Updated: 2024/11/26 19:02:27 by mvelazqu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << _name << " <ClapTrap> has been destructed" << std::endl;
	return ;
}
...
{
	std::cout << _name << " <ClapTrap> has been void constructed" << std::endl;
	return ;
}
...
{
	std::cout << _name << " <ClapTrap> has been named constructed" << std::endl;
	return ;
}

ClapTrap::ClapTrap(ClapTrap const &obj)
{
	std::cout << _name << " <ClapTrap> has been copy constructed" << std::endl;
	*this = obj;
}
